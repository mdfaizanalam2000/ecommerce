            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="price-label mb-2">
                        ...
                        <span class="badge bg-secondary ms-2">{product.rating}⭐</span>
                    </div>
                    <button onClick={null} className="btn btn-success">Add to Cart <i className="bi bi-cart-plus-fill"></i></button>
                </div>
            </div>
        </div>
    )
